...
module.exports = {
    getAllBooks: () => {return books.map(book => ({id: book.id, title: book.title}))},

    getBookById:(id) => { return books.find(book => book.id === id)},
    ...
    updateBook: (id, updatedBook) => {
        ...
        if(bookIndex === -1) throw new HttpError(404, "livro nao encontrado no sistema")
